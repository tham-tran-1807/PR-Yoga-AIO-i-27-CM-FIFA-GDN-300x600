...
lib.ssMetadata = [
		{name:"PR_Yoga_AIO_i_27_CM_FIFA_GDN_300x600_atlas_1", frames: [[0,1517,50,50],[0,0,300,600],[604,0,300,538],[604,1083,300,353],[302,1036,300,397],[0,1070,300,445],[302,602,300,432],[0,602,300,466],[302,1435,289,330],[302,0,300,600],[604,540,279,541]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_AIO_i_27_CM_FIFA_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYogaAIOi27CMFIFAGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},350).wait(40));
	...
	this.instance_2.setTransform(4,134);
	...
	this.instance_5.setTransform(0,96);
	...
	this.instance_7.setTransform(0,135);
	...
	this.instance_8.setTransform(0,62);
...
// library properties:
lib.properties = {
	id: '273A5585AACFEE4A84CD80D5AFC47DAF',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_AIO_i_27_CM_FIFA_GDN_300x600_atlas_1.png", id:"PR_Yoga_AIO_i_27_CM_FIFA_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['273A5585AACFEE4A84CD80D5AFC47DAF'] = {
